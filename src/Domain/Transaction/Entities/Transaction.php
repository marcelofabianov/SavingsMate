...
final readonly class Transaction extends Entity implements ITransaction
{
    private function __construct(
        ...
        private ?IUuid $internalTransfer,
    ...
    public function toArray(): array
    {
        return [
            ...
            'internalTransfer' => $this->internalTransfer?->toString(),
            'installmentId' => $this->installmentId?->toString(),
    ...
    public static function create(ICreateNewTransactionDto $dto): ITransaction
    {
        try {
            return new self(
                ...
                internalTransfer: $dto->internalTransfer,
